...
import PORTFOLIO_IMG1 from "../assets/exp1.png";
import PORTFOLIO_IMG2 from "../assets/exp2.png";
import PORTFOLIO_IMG3 from "../assets/exp3.png";
import PORTFOLIO_IMG4 from "../assets/exp4.png";
...
export const PORTFOLIO_DATA = [
    {
        url: "https://www.skywaywest.com/business-network-solutions",
        description: "Created responsive designs and optimized mobile experiences for the service pages, improving user accessibility across devices.",
        img: PORTFOLIO_IMG1
    },
    {
        url: "https://www.jolera.com/managed-services-pioneer-looks-to-break-new-ground/",
        description: "Developed a real-time monitoring dashboard for managed IT services, improving performance and user experience with React, Node.js, and MongoDB.",
        img: PORTFOLIO_IMG2
    },
    {
        url: "https://www.elementiq.com/ecommerce-marketing",
        description: "Developed and optimized APIs for the e-commerce platform, focusing on improving data processing and enhancing the checkout experience.",
        img: PORTFOLIO_IMG3
    },
    {
        url: "https://www.trindent.com/healthcare-services",
        description: "Overhauled the UI of the consulting services platform into a Single Page Application (SPA) using React, enhancing performance and user engagement.",
        img: PORTFOLIO_IMG4
    }
]
